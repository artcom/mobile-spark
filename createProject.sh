...
sed -i $OSX_SED_ADDON s/$TEMPLATE_NAME/$PROJECT_NAME/g kill.sh
...
mv $TEMPLATE_NAME"Delegate.mm" $PROJECT_NAME"Delegate.mm"
sed -i $OSX_SED_ADDON s/$TEMPLATE_NAME/$PROJECT_NAME/g $PROJECT_NAME"Delegate.mm"
sed -i $OSX_SED_ADDON s/$TEMPLATE_NAME_SMALL/$PROJECT_NAME_SMALL/g $PROJECT_NAME"Delegate.mm"
