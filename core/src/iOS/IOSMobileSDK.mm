...
namespace ios 
{
    ...
    masl::TextInfo IOSMobileSDK::renderText(const std::string & theMessage,
                                           ...
                                           bool & theMipmapFlag) 
    {
        ...
        NSString *filepathString = [NSString stringWithUTF8String:
                                    filePath.c_str()];
        UIImage* imageClass = [[UIImage alloc] initWithContentsOfFile:
                               filepathString];
        ...
        else 
        {
            glTexImage2D(GL_TEXTURE_2D, 0,
                         GL_RGBA, real_width, real_height, 0, GL_RGBA,
    ...
    void 
    IOSMobileSDK::freezeMobileOrientation(const std::string & theOrientation) 
    {
